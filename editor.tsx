...
const MENU_ITEMS = [
  { icon: "🆕", label: "Criar Novo Projeto", desc: "Wizard com modelos prontos", key: "criar" },
  { icon: "📄", label: "Importar Arquivo", desc: "Abrir qualquer .js .py .html .txt etc.", key: "importFile" },
  { icon: "📥", label: "Importar ZIP", desc: "Abrir arquivo .zip do dispositivo", key: "importZip" },
  { icon: "📥", label: "Importar TAR.GZ", desc: "Abrir arquivo .tar.gz / .tgz", key: "importTar" },
  { icon: "📤", label: "Exportar ZIP", desc: "Baixar projeto como .zip", key: "exportZip" },
  { icon: "🤖", label: "Assistente IA — Jasmim", desc: "Converse, peça código, debug...", key: "jasmim" },
  { icon: "🔗", label: "GitHub — Clonar / Enviar", desc: "Importar ou exportar para GitHub", key: "github" },
  { icon: "📦", label: "Instalar Biblioteca", desc: "npm install, pip install...", key: "libs" },
  { icon: "🗄️", label: "Banco de Dados (Neon/Postgres)", desc: "Conectar e rodar SQL", key: "db" },
  { icon: "📸", label: "Salvar Checkpoint", desc: "Criar ponto de restauração", key: "saveCheckpoint" },
  { icon: "🕐", label: "Histórico de Checkpoints", desc: "Ver e restaurar versões salvas", key: "checkpoints" },
  { icon: "📋", label: "Lista de Tarefas — Taski", desc: "Organizar to-dos do projeto", key: "taski" },
  { icon: "🧠", label: "Memória da Jasmim", desc: "O que ela sabe sobre você e o projeto", key: "memory" },
  { icon: "📐", label: "Gerar Plano do Projeto", desc: "Gera PLANO.md com estrutura e stack", key: "plan" },
  { icon: "📖", label: "Manual do DevMobile", desc: "Guia completo de uso em português", key: "manual" },
  { icon: "🌐", label: "Preview HTML", desc: "Visualizar arquivo .html no painel", key: "preview" },
  { icon: "🖥️", label: "Preview Servidor", desc: "Ver app Node.js/Python rodando ao vivo", key: "serverpreview" },
  { icon: "⬛", label: "Abrir Terminal", desc: "Rodar comandos bash", key: "terminal" },
  { icon: "🎮", label: "Playground HTML", desc: "Escrever e visualizar HTML na hora", key: "playground" },
  { icon: "💬", label: "Campo Livre", desc: "Chat sem restrições", key: "campolivre" },
  { icon: "🩺", label: "Status do Sistema", desc: "Ver se tudo está funcionando", key: "status" },
  { icon: "🔗", label: "Combinar Apps", desc: "Une o melhor de vários projetos num só", key: "combinar" },
  { icon: "📋", label: "Duplicar Projeto", desc: "Cria uma cópia exata do projeto atual", key: "duplicate" },
  { icon: "📂", label: "Meus Projetos", desc: "Voltar à lista de projetos", key: "projetos" },
  { icon: "🗑️", label: "Limpar Projeto", desc: "Apaga todos os arquivos", key: "clear" },
];
